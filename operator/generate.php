  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white bg-gradient-primary" href="generate.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container">
          <div class="row">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Generate Laporan</h4>
                  <p class="mb-4">Generate Laporan sesuai Status</p>
                </div>
                <div class="card-body">
                  <form action="process/cetak_pengaduan.php" role="form" id="formlapor" method="post" class="needs-validation" enctype="multipart/form-data">
                ...
                <label class="form-label">Status</label>
                    ...
                    <div class="text-center">
                      <input required type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="simpan" value="Generate">
                    </div>  
